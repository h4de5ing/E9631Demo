...
public class DashboardView3 extends View {
    ...
    private String mHeaderText = "rpm"; // 表头
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText(String.valueOf((int) (mVelocity * 1000)), mCenterX, mCenterY + dp2px(50), mPaint);
/*        int xOffset = dp2px(22);
    ...
    private void drawDigitalTube(Canvas canvas, float num, int xOffset) {
        ...
        int ly = dp2px(10);
        int gap = dp2px(2);
        //canvas.drawText(String.valueOf(num), x, y, mPaint);
       /* float x = mCenterX + xOffset;
        float y = mCenterY + dp2px(40);
        int lx = dp2px(5);
        int ly = dp2px(10);
    ...
    public void setVelocity(float velocity) {
        ...
        if (velocity < mMin) velocity = mMin;
        if (velocity > mMax) velocity = mMax;
        mVelocity = velocity;
        postInvalidate();
    }
}
